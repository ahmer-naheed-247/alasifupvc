...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="#" class="navbar-brand d-flex align-items-center py-5  px-4 px-lg-5">
            <h2 class="m-0 text-primary"><img src="img\logo.PNG" height="80" width="120" alt="logo"></h2>
        </a>
    ...
    <div class="container-fluid p-0 pb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="{{ asset('img/slider_1.jpg') }}" alt="">
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="{{ asset('img/slide_3.jpg') }}" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="#uPVC_Doors">uPVC Doors</a>
                    <a class="btn btn-link" href="#shower_cabins_vanties">Shower Cabins/Vanities</a>
                    <a class="btn btn-link" href="#sky_lights">Sky Lights</a>
                    <a class="btn btn-link" href="#sliding_windows">Sliding Windows</a>
                    <a class="btn btn-link" href="#upvc_partitions">uPVC Partitions</a>
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Al-Asif</a>, All Right Reserved.
                    </div>
